...
class Planner(models.Model):
    ...
    def render(self, template_id, planner_app):
        ...
        new_company = self.sudo().env['ir.config_parameter'].get_debranding_parameters().get('backend_debranding.new_name')
        planner_footer = self.sudo().env['ir.config_parameter'].get_debranding_parameters().get('backend_debranding.planner_footer')
