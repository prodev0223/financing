...
class EDocument(models.Model):
    ...
    @api.multi
    def isakymas_del_vaiko_prieziuros_atostogu_workflow(self):
        self.ensure_one()
    ...
    def check_workflow_constraints(self):
        ...
        for rec in self:
            if rec.template_id.id == self.env.ref('e_document.isakymas_del_vaiko_prieziuros_atostogu_template').id:
