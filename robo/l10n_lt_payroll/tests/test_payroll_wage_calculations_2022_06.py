...
class TestPayrollWageConversions202206(CommonPayrollTest):
    # Tests payroll calculations performed by Hr.Payroll for various GROSS values starting June 2022

    @classmethod
    def setUpClass(cls):
        super(TestPayrollWageConversions202206, cls).setUpClass()
        cls.calculation_date = '2022-07-01'
