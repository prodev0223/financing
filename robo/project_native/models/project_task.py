...
class Project(models.Model):
    ...
    # humanize duration
    duration_scale = fields.Char(string='Duration Scale', default='d', help="You canset: y,mo,w,d,h,m,s,ms")
    duration_picker = fields.Selection('_get_duration_picker', string='Duration Picker', default=None, help="Empty hide: day and second")
