robo.define('snabbdom.vnode', function (require) {
...
robo.define('snabbdom.is', function (require) {
    return {
        array: Array.isArray,
...
robo.define('snabbdom.h', function (require) {
...
robo.define('snabbdom.init', function (require) {
    'use strict';
...
robo.define('snabbdom.thunk', function (require) {
...
robo.define('snabbdom.class', function (require) {
...
robo.define('snabbdom.props', function (require) {
...
robo.define('snabbdom.attributes', function (require) {
    var booleanAttrs = [
...
robo.define('snabbdom.patch', function (require) {
