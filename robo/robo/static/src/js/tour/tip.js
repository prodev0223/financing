robo.define('robo.Tip', function(require) {
"use strict";
...
Tip.getConsumeEventType = function ($element) {
    //ROBO: visiskai specialus atvejis robo paieskai, kad reaguotu i Enter paspaudima ir pereitu prie kito
   // zingsnio, jei pirmas pasiulymas yra tas kurio prasome; pagalbininkas.js Enter pavercia i click!
    if ($element.is("a") && $element.filter('.menu_search_field').length > 0) {
         return 'click';
    }
