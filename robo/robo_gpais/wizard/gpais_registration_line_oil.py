...
class GpaisRegistrationLineOil(models.TransientModel):
    _name = 'gpais.registration.line.oil'

    klasifikacija = fields.Many2one('gpais.klasifikacija', string='Klasifikacija',
                                    domain="[('product_type', '=', 'alyvosGaminys')]")
    ...
    def get_line_values(self):
        res = [{
            'gpais_product_type': 'alyvosGaminys',
