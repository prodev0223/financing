...
robo.define('web_responsive', function(require) {
    'use strict';
...
/*    var $ = require('$'); */
        ...
        initDrawer: function() {
            ...
            this.$el.on('drawer.opened', function setIScrollProbes(){
                var onIScroll = function() {
                    ...
                    transform = 0; //TODO: find correct coordinate y
    ...
    core.bus.on('web_client_ready', null, function () {
        $.when(session.is_accountant(),/*user_has_group('robo_basic.group_robo_premium_accountant'),*/session.user_has_group('base.group_system'))
        .then(function(premium_accountant, base_system){
            if (premium_accountant || base_system){
                new AppDrawer();
            }
        })
