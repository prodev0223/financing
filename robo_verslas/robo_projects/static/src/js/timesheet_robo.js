robo.define('hr_timesheet_sheet.sheet_robo', function (require) {
"use strict";
...
var WeeklyTimesheetRobo = form_common.FormWidget.extend(form_common.ReinitializeWidgetMixin, {
    events: {
    ...
    initialize_content: function() {
        ...
        var holiday_deferred_presets = holidays.query(['date'])
            ...
            for (var i = 0; i < self.holiday.length; i++)
            {
                console.log('self.holiday: ' + self.holiday[i])
            }
        });
...
core.form_custom_registry.add('weekly_timesheet_robo', WeeklyTimesheetRobo);
